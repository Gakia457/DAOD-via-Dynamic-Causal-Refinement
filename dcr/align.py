"""Optional alignment components used only in ablation studies, not core DCR training."""
...
from dcr.helpers import SaveIO, grad_reverse
...
class AlignMixin(GeneralizedRCNN):
    """Alignment mixin for image-level and instance-level domain adaptation."""
